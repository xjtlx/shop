   ...
   <div class="shop-info">
     <div class="info-content">
       <section class="section">
         ...
         <div class="delivery">
          <div>
            <span class="delivery-icon">急速专送</span>
       ...
       <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="supportClassse[support.type]" v-for="(support, index) in info.supports" :key="index">
       ...
       <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsUl">
            <li class="pic-item"  v-for="(pics, index) in info.pics" :key="index">
...
export default {
  data () {
    return {
      supportClassse: ['activity-red', 'activity-green', 'activity-orange']
    }
  },
  computed: {
    ...mapState(['info'])
